...
class NotaMateria(base.Model):
    __tablename__ = 'notamateria'
    __table_args__ = {'extend_existing': True}
    

    notamateria_id = base.Column(base.Integer, primary_key=True)
    alumno_fk = base.Column(base.Integer)
    nombremateria = base.Column(base.String(2))
    notafinal = base.Column(base.Integer)
